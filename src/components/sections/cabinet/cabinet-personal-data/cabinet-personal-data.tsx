...
const CabinetPersonalData = () => {
    ...
    const { firstName, email, gender, lastName, birth } = useAppSelector(selectCabinetAccount);
        ...
        <div className={s.cabinetPersonalData}>
            <div className={s.cabinetPersonalBlock}>
                ...
                <div className={s.cabinetPersonalWrapper}>
                    <ResultFragment extraStyles={s.cabinetPersonalFragment} name={'Name'} value={firstName} resize={"page"}/>
                    <ResultFragment extraStyles={s.cabinetPersonalFragment} name={'Last name'} value={lastName} resize={"page"}/>
                    {gender && <ResultFragment extraStyles={s.cabinetPersonalFragment} name={'Gender'} value={gender} resize={"page"}/>}
                    {birth && <ResultFragment extraStyles={s.cabinetPersonalFragment} name={'Birth'} value={birth} resize={"page"}/>}
                </div>
            </div>
            <div className={s.cabinetPersonalBlock}>
                <h3>Contacts</h3>
